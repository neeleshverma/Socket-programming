...
int main(int argc, char* argv[])
{
	...
	while (true)
	{
		...
		tempstring[0] = filestring[0];
		tempstring[1] = filestring[1];
		tempstring[2] = filestring[2];
		tempstring[3] = filestring[3];
		tempstring[4] = '\0';
		if ((tempstring[0] = 'g')&&(tempstring[1] = 'e')&&(tempstring[2] = 't')&&(tempstring[3] = ' '))
		{
			int i = 4;
		...
		else if ((tempstring[0] = 'p')&&(tempstring[1] = 'u')&&(tempstring[2] = 't')&&(tempstring[3] = ' '))
		{
			int i = 4;
				while ((filestring[i] != '\0')&&(i < 10000))
				{
